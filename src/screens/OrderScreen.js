...
import {detailOrder} from "../Redux/Actions/Order/OrderDetailActions";
import Message from "../components/Error/Error";
import Loading from "../components/Loading/Loading";
import moment from "moment";
import axios from "axios";
import {ORDER_PAY_RESET} from "../Redux/Constants/Order/OrderPayConstants";
import {payOrder} from "../Redux/Actions/Order/OrderPayActions";
...
const OrderScreen = ({match}) => {
    ...
    useEffect(() => {
        ...
        if (!order || successPay) {
            ...
            if (!window.paypal) {
                addPayPalScript().then(r => console.log(r))
            } else {
                setSdkReady(true)
            }
        }
                    ...
                    <div className="col-lg-4 col-sm-4 mb-lg-4 mb-5 mb-sm-0">
                        <div className="row">
                            ...
                            <div className="col-md-8 center">
                                ...
                                </div>) : (<div className="bg-danger p-2 col-12">
                                    <p className="text-white text-center text-sm-start">
                                        Not Paid
                                    </p>
                                </div>)}
                    ...
                    <div className="col-lg-4 col-sm-4 mb-lg-4 mb-5 mb-sm-0">
                        <div className="row">
                            ...
                            <div className="col-md-8 center">
                                ...
                                {order.isDelivered ? (<div className="bg-info p-2 col-12">
                                    <p className="text-white text-center text-sm-start">
                ...
                <div className="row order-products justify-content-between">
                    <div className="col-lg-8">
                        {order.orderItems.length === 0 ? (
                            ...
                            {order.orderItems.map((item, index) => (<div className="order-product row" key={index}>
