...
const CartScreen = ({match, location, history}) => {
    ...
    return (<>
        ...
        <div className="container">
            {cartItems.length === 0 ? (<div className=" alert alert-info text-center mt-3">
                Your cart is empty
                <Link
                ...
                {/* cartsItem */}
                {cartItems.map((item) => (<div className="cart-iterm row">
                    ...
                    <div
                        className="cart-price mt-3 mt-md-0 col-md-2 align-items-sm-end align-items-start  d-flex flex-column justify-content-center col-sm-4">
                        <h6>PRICE</h6>
                        <h4>${item.price}</h4>
                    </div>
                    <div
                        className="cart-price mt-3 mt-md-0 col-md-2 align-items-sm-end align-items-start  d-flex flex-column justify-content-center col-sm-3">
                        <h6>SUBTOTAL</h6>
                ...
                <div className="cart-buttons d-flex align-items-center row">
                    ...
                    {total > 0 && (<div className="col-md-6 d-flex justify-content-md-end mt-3 mt-md-0">
