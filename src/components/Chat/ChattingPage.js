...
import {fetchCurrentMessages, sendMessage, sendMessageApi} from "../../Redux/Actions/Chat/ChattingActions";
import {addUnseenmsg} from "../../Redux/Actions/Notification/NotificationActions";
...
function InputContWithEmog({ id, token, socket }) {
  ...
  return (
    <>
      <div className="search-container send-message">
        <InputEmoji
          value={text}
          onChange={setText}
          cleanOnEnter
